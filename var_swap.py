...
def swap_test(state1, state2):
    ...
    state_1 = QuantumRegister(state1.num_qubits,name='state1')
    state_2 = QuantumRegister(state2.num_qubits,name='state2')

    qc = QuantumCircuit(anc,state_1,state_2,meas)
